# iTerm2 "Ultimate" Setup Guide 🚀

本物のエンジニア仕様にするための、究極の iTerm2 カスタマイズガイドです。
単なる「見た目の変更」にとどまらず、**Shell Integration** を駆使して生産性を最大化します。

## 1. 必須設定 (Minimal & Performance)
...
## 2. Shell Integration (これが「イケてる」の正体)
